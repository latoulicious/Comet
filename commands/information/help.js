  ...
  run: async (client, message, args) => {
    ...
    if (!args[0]) {
      const embed = new MessageEmbed()
        ...
        .addField(
          "• Important Links",
          `**[Invite Link](https://discord.com/api/oauth2/authorize?client_id=${client.user.id}&permissions=8&scope=bot)\`|\`[Support Server](https://discord.com/invite/tVWrU5PWZV)**`
        )
        .setTimestamp();
      ...
      if (cots.includes(args[0].toLowerCase())) {
        const combed = new MessageEmbed()
          ...
          .setColor("RANDOM")
          .setFooter(`Coded By GrimoireDev`);
